...
int main()
{
	...
	bitmapHelper.saveBitmapValues(width, height, bytesPerPixel, data_pix);

	data_pix_from_saved_bitmap = bitmapHelper.bitmap.pixelData;
	data_pix = data_pix_from_saved_bitmap;
